...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private List<CarouselModl> infos;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View view = LayoutInflater.from(getActivity()).inflate(
				R.layout.activity_home_view_cycle_viewpager_contet, null);
	...
	public void setData(List<ImageView> views, List<CarouselModl> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<CarouselModl> list, ImageCycleViewListener listener, int showPosition) {
		...
		for (int i = 0; i < indicators.length; i++) {
			View view = LayoutInflater.from(getActivity()).inflate(
					R.layout.activity_home_view_cycle_viewpager_indicator, null);
