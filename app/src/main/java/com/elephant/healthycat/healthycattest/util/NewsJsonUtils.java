...
public class NewsJsonUtils {
     ...
     * @return
     */
    public static List<DiscroveryBean> readJsonNewsBeans(String res, String value) {
        List<DiscroveryBean> beans = new ArrayList<>();
        try {
            ...
            for (int i = 1; i < jsonArray.size(); i++) {
                ...
                if (!jo.has("imgextra")) {
                    DiscroveryBean news = JsonUtils.deserialize(jo, DiscroveryBean.class);
                    beans.add(news);
                }
            }
        } catch (Exception e) {
